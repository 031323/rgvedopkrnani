...
p1 = len(Uu)/n1
p2 = len(Au)/n2
p = (len(Uu) + len(Au)) / (n1 + n2)

print(f'\nउ॒दात्ते॑ पूर्व्या॒र्धे स॒त्यु॑त्तमा॒र्धाना॑म् उदात्त॒त्वम्\t{p1}')
print(f'अनु॑दात्ते पूर्व्या॒र्धे स॒त्यु॑त्तमा॒र्धाना॑म् उदात्त॒त्वम्\t{p2}')
...
print((p1 - p2) / sqrt(p * (1 - p) * (1 / n1 + 1 / n2)))